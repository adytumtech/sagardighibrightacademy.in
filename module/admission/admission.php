...
class admission extends Controller {
    ...
    {
        $this->view->pageTitle = "Admission Procedure | Don Bosco Malda";
    ...
    {
        $this->view->pageTitle = "Admission Online Apply | Don Bosco Malda";
    ...
    {
        $this->view->pageTitle = "School Timing | Don Bosco Malda";
    ...
    {
        $this->view->pageTitle = "School Uniform | Don Bosco Malda";
    ...
    {
        $this->view->pageTitle = "School Rules  | Don Bosco Malda";
