...
class academic extends Controller {
    ...
    {
        $this->view->pageTitle = "Academic Curriculum | Don Bosco Malda";
    ...
    {
        $this->view->pageTitle = "Academic Visiting Hours | Don Bosco Malda";
    ...
    {
        $this->view->pageTitle = "Activities | Don Bosco Malda";
        $this->view->css = array("views/academic/academic.css");
        $this->view->js = array("views/academic/academic.js");
    ...
    {
        $this->view->pageTitle = "Early Years | Don Bosco Malda";
        $this->view->css = array("views/academic/academic.css");
        $this->view->js = array("views/academic/academic.js");
    ...
    {
        $this->view->pageTitle = "Primary School | Don Bosco Malda";
        $this->view->css = array("views/academic/academic.css");
        $this->view->js = array("views/academic/academic.js");
    ...
    {
        $this->view->pageTitle = "Middle School | Don Bosco Malda";
        $this->view->css = array("views/academic/academic.css");
        $this->view->js = array("views/academic/academic.js");
    ...
    {
        $this->view->pageTitle = " High School | Don Bosco Malda";
        $this->view->css = array("views/academic/academic.css");
        $this->view->js = array("views/academic/academic.js");
    ...
    {
        $this->view->pageTitle = " Remedial School | Don Bosco Malda";
        $this->view->css = array("views/academic/academic.css");
        $this->view->js = array("views/academic/academic.js");
