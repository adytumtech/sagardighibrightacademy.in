...
<div class="max-w-7xl mx-auto my-8 p-4 lg:p-0">
  <h1 class="text-3xl md:text-4xl font-bold text-gray-700 mb-8 text-center">Night Stay</h1>
  <div class="py-4">
    <h2 class="text-start text-lg md:text-xl lg:text-2xl font-bold text-gray-700">About Night Stay</h2>
    <p class="text-sm md:text-base lg:text-lg text-justify text-gray-600">
      Don Bosco Malda’s Night Stay program is an exciting overnight adventure that strengthens friendships and independence. Students enjoy team games, storytelling, stargazing, and group activities under the supervision of teachers. This fun-filled event helps children develop responsibility, cooperation, and self-confidence. It’s a memorable experience that students cherish long after the night ends.
    </p>
  </div>
  <h2 class="text-start text-lg md:text-xl lg:text-2xl font-bold text-gray-700 mb-4">Images</h2>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 px-2 md:px-0" id="gallery">
      <div><img src="<?php echo URL?>assets/img/donbosco-events/night stay.jpg" alt="" class="gallery-image w-full h-64 object-cover cursor-pointer shadow border-2 border-gray-800"></div>
