...
<section class="w-full bg-blue-100 py-16">
  <div class="max-w-6xl mx-auto px-5">
    ...
    <div class="grid md:grid-cols-2 gap-10">
      ...
      <!-- Vision -->
      <div class="bg-white border-l-4 border-blue-800 p-8 rounded-xl shadow-md">
        <h3 class="text-xl font-semibold text-blue-800 mb-4">
          Our Vision
        </h3>
        <p class="text-gray-700 leading-relaxed">
          To empower students with quality education, strong discipline, and ethical values,
          enabling them to grow into confident, responsible, and socially conscious citizens.
        </p>
      </div>

      <!-- Mission -->
      <div class="bg-white border-l-4 border-yellow-400 p-8 rounded-xl shadow-md">
        <h3 class="text-xl font-semibold text-blue-800 mb-4">
          Our Mission
        </h3>
        <ul class="space-y-3 text-gray-700 leading-relaxed list-disc pl-5">
          <li>Deliver strong academic foundations through effective teaching</li>
          <li>Promote discipline, integrity, and moral values</li>
          <li>Ensure a safe, inclusive, and supportive learning environment</li>
          <li>Encourage holistic development and lifelong learning</li>
        </ul>
      </div>
...
<section class="bg-gray-50 py-16">
  <div class="max-w-6xl mx-auto px-5 text-center">
    <h2 class="text-3xl md:text-4xl font-bold text-blue-900 mb-6 tracking-wide">
      Our Commitment
    </h2>

    <div class="w-20 h-1 bg-blue-800 mx-auto mb-8"></div>

    <p class="text-gray-700 leading-relaxed max-w-4xl mx-auto text-lg">
      At SAGARDIGHI BRIGHT ACADEMY, we are committed to shaping young minds through
      academic excellence, discipline, and character building. Our dedicated faculty works
      closely with students to nurture confidence, responsibility, and a lifelong love for learning,
...
<section class="w-full bg-gray-50 py-16">
  <div class="max-w-6xl mx-auto px-5">
    ...
    <div class="max-w-xl mx-auto bg-gray-50 rounded-xl shadow-md p-8">
