    ...
    <div class="space-y-6 w-full lg:w-1/3 flex flex-col">
      ...
      <div class="bg-blue-800 border-l-4 border-yellow-400 p-6 shadow">
        ...
        <ul class="text-white space-y-2 list-disc pl-5 text-sm">
          ...
          <li><strong>Phone:</strong> <a href="tel:9733656523" class="text-yellow-300 hover:underline">+91-9733656523</a></li>
          <li><strong>Email:</strong> <a href="mailto:sagardighibrightacademy2007@gmail.com
" class="text-yellow-300 hover:underline"> sagardighibrightacademy2007@gmail.com
            </a></li>
        </ul>
      </div>
      <!-- Embedded Google Map -->
