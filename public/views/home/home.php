...
<main class=" flex flex-col bg-white z-10">
    ...
    <div id="hero-carousel" class="relative w-full overflow-hidden">
      <div id="carousel-images" class="relative w-full h-[40vh] md:h-[60vh] lg:h-[80vh]">
        <div class="absolute inset-0 w-full h-full transition-opacity duration-1000 ease-in-out opacity-100">
          <img src="<?php echo URL ?>https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcSmkQ_sFFWl1wj5RFQ4Q2ygqoC5PiBtig8R8fTQvAFgjKPYmdCRe1mIn4PQYipB5LHaJBFtw64K" alt="Hero Image 1" class="w-full h-full object-cover">
        </div>
        <div class="absolute inset-0 w-full h-full transition-opacity duration-1000 ease-in-out opacity-100">
          <img src="<?php echo URL ?>assets/img/hero-images/img-2.jpg" alt="Hero Image 2" class="w-full h-full object-cover">
        </div>
        <div class="absolute inset-0 w-full h-full transition-opacity duration-1000 ease-in-out opacity-100">
          <img src="<?php echo URL ?>assets/img/hero-images/img-3.jpg" alt="Hero Image 3" class="w-full h-full object-cover">
        </div>
        <div class="absolute inset-0 w-full h-full transition-opacity duration-1000 ease-in-out opacity-100">
      ...
      <div class="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 z-20" id="carousel-indicators">
        ...
        <span class="w-3 h-3 bg-white rounded-sm inline-block cursor-pointer opacity-80 transition-all duration-300" data-index="3"></span>
        <span class="w-3 h-3 bg-white rounded-sm inline-block cursor-pointer opacity-80 transition-all duration-300" data-index="4"></span>
        <span class="w-3 h-3 bg-white rounded-sm inline-block cursor-pointer opacity-80 transition-all duration-300" data-index="5"></span>
        <span class="w-3 h-3 bg-white rounded-sm inline-block cursor-pointer opacity-80 transition-all duration-300" data-index="6"></span>
      </div>
    </div>
  </section>

  <div class="relative w-full bg-cover bg-center bg-[#173572] backdrop-blur-md">
    <ul class="flex flex-wrap items-center justify-evenly w-full text-white min-h-[80px] md:min-h-[120px] px-4 py-4 bg-white/10 backdrop-blur-md border border-white/30 shadow-xl rounded-xl mx-auto max-w-7xl">
      <!-- Admission -->
      <li class="flex items-center gap-3 px-4 py-2 hover:text-blue-200 transition">
  ...
  <section class="px-2 md:px-10 lg:px-20 py-6 md:py-0 h-auto lg:h-[68vh]">
    <div class="flex flex-col md:flex-row gap-6 md:gap-10 lg:h-full ">
      ...
      <div class="w-full h-[70vh] md:h-full md:w-1/3 bg-blue-50 p-4 shadow border border-blue-100">
  ...
  <section class="w-full">
    <div class="bg-[#173572] py-8 md:py-12 text-white text-center" style="background-image: url('<?php echo URL ?>assets/img/pngbg.png'); background-size: cover; background-position: center;">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4 md:px-10 lg:px-20 pb-10">
        ...
        <div class="bg-white hover:bg-blue-50 transition-all duration-300 shadow-lg p-6 flex flex-col items-center text-center text-blue-900 h-full border border-blue-100">
          ...
          <div id="event-carousel-track" class="flex transition-transform duration-500 ease-in-out">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3 px-4 flex-shrink-0">
              <div class="bg-white border-2 border-blue-500 shadow-md overflow-hidden hover:shadow-2xl hover:bg-blue-50 transition-shadow duration-300 h-full">
                <img src="<?php echo URL ?>assets/img/donbosco-events/science festival.jpg" alt="Science Festival" class="w-full h-48 object-cover">
                <div class="p-6">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3 px-4 flex-shrink-0 ">
              <div class="bg-white border-2 border-blue-500 shadow-md overflow-hidden hover:shadow-2xl hover:bg-blue-50 transition-shadow duration-300 h-full">
                <img src="<?php echo URL ?>assets/img/donbosco-events/sport.jpg" alt="Sports Day" class="w-full h-48 object-cover">
                <div class="p-6">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3 px-4 flex-shrink-0">
              <div class="bg-white border-2 border-blue-500 shadow-md overflow-hidden hover:shadow-2xl hover:bg-blue-50 transition-shadow duration-300 h-full">
                <img src="<?php echo URL ?>assets/img/donbosco-events/rabindra jayanti.jpg" alt="Rabindra Jayanti" class="w-full h-48 object-cover">
                <div class="p-6">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3 px-4 flex-shrink-0">
              <div class="bg-white border-2 border-blue-500 shadow-md overflow-hidden hover:shadow-2xl hover:bg-blue-50 transition-shadow duration-300 h-full">
                <img src="<?php echo URL ?>assets/img/donbosco-events/grandparents day.jpg" alt="Grandparents Day" class="w-full h-48 object-cover">
                <div class="p-6">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3 px-4 flex-shrink-0">
              <div class="bg-white border-2 border-blue-500 shadow-md overflow-hidden hover:shadow-2xl hover:bg-blue-50 transition-shadow duration-300 h-full">
                <img src="<?php echo URL ?>assets/img/donbosco-events/rath.jpg" alt="Rathyatra" class="w-full h-48 object-cover">
                <div class="p-6">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3 px-4 flex-shrink-0">
              <div class="bg-white border-2 border-blue-500 shadow-md overflow-hidden hover:shadow-2xl hover:bg-blue-50 transition-shadow duration-300 h-full">
                <img src="<?php echo URL ?>assets/img/donbosco-events/night stay.jpg" alt="Night Stay" class="w-full h-48 object-cover">
                <div class="p-6">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3 px-4 flex-shrink-0">
              <div class="bg-white border-2 border-blue-500 shadow-md overflow-hidden hover:shadow-2xl hover:bg-blue-50 transition-shadow duration-300 h-full">
                <img src="<?php echo URL ?>assets/img/donbosco-events/wow.jpg" alt="WOW Day" class="w-full h-48 object-cover">
                <div class="p-6">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3 px-4 flex-shrink-0">
              <div class="bg-white border-2 border-blue-500 shadow-md overflow-hidden hover:shadow-2xl hover:bg-blue-50 transition-shadow duration-300 h-full">
                <img src="<?php echo URL ?>assets/img/donbosco-events/christmas.jpg" alt="Christmas Celebration" class="w-full h-48 object-cover">
                <div class="p-6">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3 px-4 flex-shrink-0">
              <div class="bg-white border-2 border-blue-500 shadow-md overflow-hidden hover:shadow-2xl hover:bg-blue-50 transition-shadow duration-300 h-full">
                <img src="<?php echo URL ?>assets/img/donbosco-events/space on wheel.jpg" alt="Space on Wheels" class="w-full h-48 object-cover">
                <div class="p-6">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3 px-4 flex-shrink-0">
              <div class="bg-white border-2 border-blue-500 shadow-md overflow-hidden hover:shadow-2xl hover:bg-blue-50 transition-shadow duration-300 h-full">
                <img src="<?php echo URL ?>assets/img/donbosco-events/school picnic.jpg" alt="School Picnic" class="w-full h-48 object-cover">
                <div class="p-6">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3 px-4 flex-shrink-0">
              <div class="bg-white border-2 border-blue-500 shadow-md overflow-hidden hover:shadow-2xl hover:bg-blue-50 transition-shadow duration-300 h-full">
                <img src="<?php echo URL ?>assets/img/donbosco-events/sea model.jpg" alt="Sea Model Exhibition" class="w-full h-48 object-cover">
                <div class="p-6">
  ...
  <section class="w-full h-auto lg:h-[400px] flex flex-col md:flex-row bg-blue-50">
    <div class="p-6 w-full md:w-1/2 h-full flex flex-col ">
      <h1 class="text-2xl font-semibold text-blue-800">Overview</h1>
