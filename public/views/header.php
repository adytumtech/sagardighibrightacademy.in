...
<header class="w-full sticky top-0 z-50 shadow-md bg-white">
  <!-- Top Contact Bar -->
  <div class="w-full text-white bg-gradient-to-r from-blue-600 to-blue-800 px-4 lg:px-10 py-1.5 flex flex-col md:flex-row justify-between items-center gap-2 text-xs md:text-sm">
    ...
    <nav class="max-w-8xl mx-auto px-4  py-3 md:py-2 flex items-center justify-between" role="navigation" aria-label="Main navigation">
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="leading-tight">
          <h1 class="text-sm lg:text-lg font-bold tracking-tight text-blue-700">
      ...
      <ul id="mobile-menu"
        ...
        <!-- About Dropdown -->
          ...
          <!-- About Us -->
          <li class="hover:text-[#9F4143] cursor-pointer group relative lg:h-full lg:flex w-full lg:w-auto px-2 py-1">
            <div id="submenu-btn" class="flex gap-1 items-center font-semibold">
              About Us <i class="fa-solid fa-angle-down"></i>
            </div>
            <ul id="sub-items" class="hidden lg:group-hover:block lg:absolute lg:left-0 lg:top-full bg-[#af4547df] text-white  lg:shadow-lg lg:z-50 lg:min-w-[250px] lg:max-w-[250px] whitespace-nowrap text-start">
              <li class="border-b"><a href="<?php echo URL ?>about/about_school" class="block px-4 py-2 hover:bg-[#af4547] hover:text-yellow-300">About School</a></li>
              <li class="border-b"><a href="<?php echo URL ?>about/st_donbosc_visionary" class="block px-4 py-2 hover:bg-[#af4547] hover:text-yellow-300">St. Don Bosco: The Visionary</a></li>
              <li class="border-b"><a href="<?php echo URL ?>about/founder" class="block px-4 py-2 hover:bg-[#af4547] hover:text-yellow-300">Founder</a></li>
              <li class="border-b"><a href="<?php echo URL ?>about/chairman" class="block px-4 py-2 hover:bg-[#af4547] hover:text-yellow-300">Chairman message</a></li>
              <li class="border-b"><a href="<?php echo URL ?>about/principal" class="block px-4 py-2 hover:bg-[#af4547] hover:text-yellow-300">Principal message</a></li>
              <li class="border-t"><a href="<?php echo URL ?>about/director" class="block px-4 py-2 hover:bg-[#af4547] hover:text-yellow-300">Director</a></li>
            </ul>
          </li>
        ...
        <!-- Admission Dropdown -->
        <li class="w-full lg:w-auto"><a href="#" class="block py-2 lg:py-0 px-2 font-semibold text-gray-800 hover:text-blue-700 transition-colors">Admission</a></li>

        <li class="w-full lg:w-auto"><a href="<?php echo URL?>gallery" class="block py-2 lg:py-0 px-2 font-semibold text-gray-800 hover:text-blue-700 transition-colors">Gallery</a></li>
        <li class="w-full lg:w-auto"><a href="<?php echo URL?>events" class="block py-2 lg:py-0 px-2 font-semibold text-gray-800 hover:text-blue-700 transition-colors">Events</a></li>
        <li class="w-full lg:w-auto"><a href="<?php echo URL?>career" class="block py-2 lg:py-0 px-2 font-semibold text-gray-800 hover:text-blue-700 transition-colors">Career</a></li>
        <li class="w-full lg:w-auto"><a href="<?php echo URL?>contact" class="block py-2 lg:py-0 px-2 font-semibold text-gray-800 hover:text-blue-700 transition-colors">Contact</a></li>
